# @codestepteam/next-dev-feedback
...
```bash
npm install @codestepteam/next-dev-feedback
npx @codestepteam/next-dev-feedback init
```
...
```bash
npx @codestepteam/next-dev-feedback init --dry-run
```
...
import type {
  DevFeedbackMetadata,
  DevFeedbackSummary,
} from "@codestepteam/next-dev-feedback/types";
```
